package com.andev.post.model.constants;
...
public enum ApiErrorMessage {
    RESOURCE_NOT_FOUND_BY_ID("Resource with ID: %s was not found"),
    RESOURCE_FOUND_BY_ID("Resource with ID: %s founded"),
    POST_ALREADY_EXISTS("Post with Title: %s already exists"),
    USER_NOT_FOUND_BY_ID("Author with ID: %s was not found"),
