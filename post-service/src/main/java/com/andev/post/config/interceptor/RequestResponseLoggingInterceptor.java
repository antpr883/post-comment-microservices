package com.andev.post.config.interceptor;
...
/**
 * HTTP Request/Response logging interceptor for Post Service.
 * 
...
public class RequestResponseLoggingInterceptor implements HandlerInterceptor {
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, 
        ...
        try {
            ...
            long executionTime = stopWatch != null ? stopWatch.getTotalTimeMillis() : 
