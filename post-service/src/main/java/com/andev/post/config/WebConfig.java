...
import com.andev.post.config.interceptor.RequestResponseLoggingInterceptor;

/**
 * Web MVC configuration for Post Service.
 * 
 * Configures request/response logging and other web-related settings.
 */
@Configuration("postWebConfig")
